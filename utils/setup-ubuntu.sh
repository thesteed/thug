...
sudo apt-get install subversion git python build-essential python-setuptools libboost-python-dev libboost-thread-dev python-dev \
	build-essential git-core autoconf libtool python-pip libpcre3 libpcre3-dev libboost-system-dev libboost-dev systemtap-sdt-dev
...
sudo easy_install jsbeautifier 1>>setup-ubuntu.log
